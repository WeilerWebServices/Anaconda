...
Once the `conda-forge` channel has been enabled, `shellingham` can be installed with:

```
conda install shellingham
```

It is possible to list all of the versions of `shellingham` available on your platform with:
