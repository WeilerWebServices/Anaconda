...
/**
 * Classe que representa uma enumera��o de chaves de cache, criada a partir de uma enumera��o de Strings (valores das chaves)
 *
 * @see CacheKey
 * @see ObjectCacheKey
...
//    Enumeration enum; // Armazena a enumera��o de Strings (valores das chaves)
