...
public class Html2Txt {
    ...
    public Html2Txt() {
        ...
        ansiTable.put("Agrave;", "\u00C0");
        ansiTable.put("Aacute;", "\u00C1");
        ansiTable.put("Acirc;", "\u00C2");
        ansiTable.put("Atilde;", "\u00C3");
        ansiTable.put("Auml;", "\u00C4");
        ansiTable.put("Aring;", "\u00C5");
        ansiTable.put("AElig;", "\u00C6");
        ansiTable.put("Ccedil;", "\u00C7");
        ansiTable.put("Egrave;", "\u00C8");
        ansiTable.put("Eacute;", "\u00C9");
        ansiTable.put("Ecirc;", "\u00CA");
        ansiTable.put("Euml;", "\u00CB");
        ansiTable.put("Igrave;", "\u00CC");
        ansiTable.put("Iacute;", "\u00CD");
        ansiTable.put("Icirc;", "\u00CE");
        ansiTable.put("Iuml;", "\u00CF");
        ansiTable.put("ETH;", "\u00D0");
        ansiTable.put("Ntilde;", "\u00D1");
        ansiTable.put("Ograve;", "\u00D2");
        ansiTable.put("Oacute;", "\u00D3");
        ansiTable.put("Ocirc;", "\u00D4");
        ansiTable.put("Otilde;", "\u00D5");
        ansiTable.put("Ouml;", "\u00D6");
        ansiTable.put("times;", "\u00D7");
        ansiTable.put("Oslash;", "\u00D8");
        ansiTable.put("Ugrave;", "\u00D9");
        ansiTable.put("Uacute;", "\u00DA");
        ansiTable.put("Ucirc;", "\u00DB");
        ansiTable.put("Uuml;", "\u00DC");
        ansiTable.put("Yacute;", "\u00DD");
        ansiTable.put("THORN;", "\u00DE");
        ansiTable.put("szlig;", "\u00DF");
        ansiTable.put("agrave;", "\u00E0");
        ansiTable.put("aacute;", "\u00E1");
        ansiTable.put("acirc;", "\u00E2");
        ansiTable.put("atilde;", "\u00E3");
