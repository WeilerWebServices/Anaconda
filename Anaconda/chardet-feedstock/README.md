...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/chardet-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/chardet-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/chardet-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/chardet-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/chardet-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/chardet-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `chardet` can be installed with:

```
conda install chardet
```

It is possible to list all of the versions of `chardet` available on your platform with:
